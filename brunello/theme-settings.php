...
function brunello_settings($saved_settings, $subtheme_defaults = array()) {

  // Get the default values from the .info file.
  $defaults = brunello_theme_get_default_settings('brunello');
  ...
  $form['brunello_breadcrumb'] = array(
    '#type'          => 'fieldset',
    '#title'         => t('Breadcrumb settings'),
    '#attributes'    => array('id' => 'brunello-breadcrumb'),
  );
  $form['brunello_breadcrumb']['brunello_breadcrumb'] = array(
    '#type'          => 'select',
    '#title'         => t('Display breadcrumb'),
    '#default_value' => $settings['brunello_breadcrumb'],
    '#options'       => array(
                          'yes'   => t('Yes'),
  ...
  $form['brunello_breadcrumb']['brunello_breadcrumb_separator'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Breadcrumb separator'),
    '#description'   => t('Text only. Don’t forget to include spaces.'),
    '#default_value' => $settings['brunello_breadcrumb_separator'],
    '#size'          => 5,
    '#maxlength'     => 10,
    '#prefix'        => '<div id="div-brunello-breadcrumb-collapse">', // jquery hook to show/hide optional widgets
  );
  $form['brunello_breadcrumb']['brunello_breadcrumb_home'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Show home page link in breadcrumb'),
    '#default_value' => $settings['brunello_breadcrumb_home'],
  );
  $form['brunello_breadcrumb']['brunello_breadcrumb_trailing'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append a separator to the end of the breadcrumb'),
    '#default_value' => $settings['brunello_breadcrumb_trailing'],
    '#description'   => t('Useful when the breadcrumb is placed just before the title.'),
  );
  $form['brunello_breadcrumb']['brunello_breadcrumb_title'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append the content title to the end of the breadcrumb'),
    '#default_value' => $settings['brunello_breadcrumb_title'],
    '#description'   => t('Useful when the breadcrumb is not placed just before the title.'),
    '#suffix'        => '</div>', // #div-zen-breadcrumb
  );

  $form['brunello_block_editing'] = array(
    '#type'          => 'checkbox',
    ...
    '#default_value' => $settings['brunello_block_editing'],
    '#prefix'        => '<strong>' . t('Block Edit Links:') . '</strong>',
  );

  $form['themedev']['brunello_rebuild_registry'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Rebuild theme registry on every page.'),
    '#default_value' => $settings['brunello_rebuild_registry'],
    '#description'   => t('During theme development, it can be very useful to continuously <a href="!link">rebuild the theme registry</a>. WARNING: this is a huge performance penalty and must be turned off on production websites.', array('!link' => 'http://drupal.org/node/173880#theme-registry')),
    '#prefix'        => '<div id="div-brunello-registry"><strong>' . t('Theme registry:') . '</strong>',
    '#suffix'        => '</div>',
  );
 ...
 */
function brunello_theme(&$existing, $type, $theme, $path) {
  ...
  // @TODO: When PHP 5 becomes required (brunello 7.x), use the following faster
  ...
  brunello_theme_get_default_settings($theme);
...
function brunello_theme_get_default_settings($theme) {
  $themes = list_themes();
